...
## 3. Suppose there is a second data frame that contains additional information
...
## 4. Suppose that a measure of 'irritability' (scale from 0 to 10) was also
...
## 5. Repeat the above task using the 'reshape' function.
